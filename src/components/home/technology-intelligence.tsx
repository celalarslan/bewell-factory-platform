import { technologyPoints } from "@/data/home";
import Reveal from "@/components/ui/reveal";
import SectionHeading from "@/components/ui/section-heading";

export default function TechnologyIntelligenceSection() {
  return (
    <section id="insights" className="bg-[#080b0f] py-24">
      <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[.85fr_1.15fr] lg:items-start">
          <div>
            <SectionHeading
              eyebrow="Technology-Enabled Project Intelligence"
              title="Technology strengthens the process. Accountability remains human."
              description="Digital and AI-assisted tools support internal project analysis, supplier evaluation, cost scenarios, document preparation and risk review."
            />
          </div>
