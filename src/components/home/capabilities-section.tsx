    ...
    <section id="capabilities" className="bg-[#080b0f] py-24">
      <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
        <SectionHeading
          ...
          title="One coordinated path from project opportunity to operational industry."
          description="The work is structured as a controlled industrial delivery chain, not a loose collection of isolated services."
        />
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-6">
                  <div>
                    <div className="text-xs font-semibold tracking-[0.28em] text-[#9faaa4]">{item.step}</div>
